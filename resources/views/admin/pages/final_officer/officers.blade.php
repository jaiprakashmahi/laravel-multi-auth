...
@section('content')
    ...
    <section class="content-header">
        <h1>
           Add New Final Technical Sanction Officer
        </h1>
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-header">
                        {!! Form::open(array('route' => 'admin.final-officer.store' , 'method'=>'POST','autocomplete'=>"off")) !!}
                        {!! csrf_field() !!}
...
<!--                    <strong>{{$errors->first('name')}} </strong>-->
                        ...
                        <div class="{{ $errors->has('name') ? ' has-error' : '' }}">
                            <div class="form-group">
                                <label for="exampleInputEmail1"> Final Technical Sanction Officer Name</label>

                                {!! Form::text('name', null, ['class' => 'form-control','placeholder'=>'Enter Final Technical Sanction Officer' ]) !!}
