...
<section class="content-header">
    <h1>
        View / Edit Final Technical Sanction Officer
    </h1>
                ...
                <div class="box-header">
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{URL::route('admin.final-officer.edit',$officer_data_value->id)}}"><i class="fa fa-pencil"></i></a>
                                <!--                                    <button class="btn btn-primary" data-ui-sref="home.works.update">Update Status</button>-->
                                <a class="btn btn-danger" href="{{URL::route('admin.final-officer.remove',$officer_data_value->id)}}" onclick="return confirm('Are you sure to delete')">Delete</a>
                            </td>
                        </tr>
                        @endforeach
