...
<section class="content-header">
    <h1>
        Edit Final Technical Sanction Officer
    </h1>
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    ['route' => ['admin.final-officer.update',$officer_details->id],
...
<!--                    <strong>{{$errors->first('pin')}} </strong>-->
                    ...
                    <a href="{{ URL::route('admin.final-officer.index') }}" class="btn btn-default"> Back</a>
