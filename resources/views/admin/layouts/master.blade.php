...
<script>
    ...
    $("#plane_id").change(function(e) {
        ...
        $.get("/admin/work/sector/" + this.value, function (data) {
    ...
    $("#sector_id").change(function(e) {
        ...
        $.get("/admin/work/sub_sector/" + this.value, function (data) {
...
//  Ajax for Sub secto  CURD

    $("#plane_id_sub_sector").change(function(e) {

        if (this.value == "" || this.value == "undefined") {
            $("#sector_id_sub_sector").html("");
//            $("#sub_sector_id").html("");
//            $("#scheme_id").html("");
            $("#sector_id_sub_sector").append($('<option>').text("Select Sector").attr('value', ""));
//            $("#sub_sector_id").append($('<option>').text("Select Sub Sector").attr('value', ""));
//            $("#scheme_id").append($('<option>').text("Select Scheme").attr('value', ""));
...
//            $("#scheme_id").append($('<option>').text("Select Scheme").attr('value', ""));
            ...
            $.each(data, function (i, value) {
                ...
                $("#sector_id_sub_sector").append($('<option>').text(value.name).attr('value', value.id));
            });
